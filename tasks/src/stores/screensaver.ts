...
const colorPalette = [
  ...
  'red-5', 'pink-5', 'purple-5', 'deep-purple-5', 'indigo-5', 'blue-5', 'light-blue-5', 'cyan-5', 'teal-5', 'green-5', 'light-green-5', 'lime-5', 'yellow-5', 'amber-5', 'orange-5', 'deep-orange-5', 'brown-5', 'grey-5', 'blue-grey-5'
]
